 ...
 */
class Ccff_PostTypes extends Ccff_Base {
	...
	public function initialize() {
		...
		$post_columns->add_column( 'cmb2_field', array(
				'label'    => __( 'CMB2 Field', CCFF_TEXTDOMAIN ),
				'type'     => 'post_meta',
				'meta_key' => '_demo_' . CCFF_TEXTDOMAIN . '_text',
				'orderby'  => 'meta_value',
				'sortable' => true,
				'prefix'   => '<b>',
				'suffix'   => '</b>',
	...
	public function load_cpts() {
		...
		$tax = register_extended_post_type( 'demo', array(
			...
			'singular' => __( 'Demo', CCFF_TEXTDOMAIN ),
			'plural'   => __( 'Demos', CCFF_TEXTDOMAIN ),
			)
		);
		...
		register_extended_taxonomy( 'demo-section', 'demo', array(
			...
			// Override the base names used for labels:
			'singular' => __( 'Demo Category', CCFF_TEXTDOMAIN ),
			'plural'   => __( 'Demo Categories', CCFF_TEXTDOMAIN ),
		)
		);
	}
